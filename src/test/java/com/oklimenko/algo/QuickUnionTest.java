...
public class QuickUnionTest {
    ...
    private void isStreamsEqual(IntStream quickUnion, IntStream target) {
        PrimitiveIterator.OfInt iter1 = quickUnion.iterator();
        PrimitiveIterator.OfInt iter2 = target.iterator();
